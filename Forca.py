...
while True:
    ...
    if Tema in ('Nomes', 'Frutas', 'Carros', 'Aleatorio', 'Escolha', 'Anime', 'Jogos'):
        if Tema == 'Nomes':
            Nome_Escolhido += choice(Nomes)        #escolhe uma plavra no tema e recebe separada
        elif Tema == 'Anime':
            Nome_Escolhido += choice(Anime)
        elif Tema == 'Jogos':
            Nome_Escolhido += choice(Jogos)
        elif Tema == 'Frutas':
            Nome_Escolhido += choice(Frutas)
        elif Tema == 'Carros':
            Nome_Escolhido += choice(Carros)
        elif Tema == 'Aleatorio':
            Nome_Escolhido += choice(Aleatorio)
        elif Tema == 'Escolha':
